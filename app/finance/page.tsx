  ...
  // This will be checked server-side in a real implementation
	...
	return (
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-24 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
					<div>
            <h1 className="text-xl sm:text-2xl font-bold text-white">💰 Finance</h1>
            <p className="text-xs sm:text-sm text-gray-300">Manage invoices and view financial summaries</p>
					</div>
          <Link
            href="/dashboard"
